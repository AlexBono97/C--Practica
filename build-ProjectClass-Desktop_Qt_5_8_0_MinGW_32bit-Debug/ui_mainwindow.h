...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(60, 220, 75, 23));
        ...
        progressBar->setGeometry(QRect(20, 50, 171, 23));
        progressBar->setValue(24);
        progressBar_2 = new QProgressBar(centralWidget);
        progressBar_2->setObjectName(QStringLiteral("progressBar_2"));
        progressBar_2->setGeometry(QRect(20, 90, 181, 23));
        ...
        gv1->setGeometry(QRect(205, 10, 271, 101));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QApplication::translate("MainWindow", "END TASK", Q_NULLPTR));
    } // retranslateUi
